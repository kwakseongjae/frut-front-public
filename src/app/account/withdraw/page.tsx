      ...
      <div className="flex-1 px-5 py-4">
        <div className="flex flex-col gap-5">
          ...
          <div className="border border-[#D9D9D9] rounded-lg p-4 bg-white">
            <div className="flex flex-col gap-3 text-sm text-[#262626]">
              <p className="font-semibold">
                * 탈퇴 전 아래 내용을 확인해주세요.
              </p>
              <ul className="flex flex-col gap-1 list-none">
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                  <span>
                    진행 중인 주문·환불·CS가 있을 경우 모든 처리가 완료된 후
                    탈퇴가 가능합니다.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                  <span>탈퇴 후 동일 아이디로 재가입은 불가합니다.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                  <span>
              ...
              <ul className="flex flex-col gap-1 ml-4 list-none">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    계약·청약철회 관련 기록:{" "}
                    <span className="text-[#133A1B]">5년</span>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    소비자의 불만·분쟁처리 기록:{" "}
                    <span className="text-[#133A1B]">3년</span>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                  <span>
                    표시·광고에 관한 기록:{" "}
                    <span className="text-[#133A1B]">6개월</span>
                  </span>
                </li>
              </ul>
              <ul className="flex flex-col gap-1 text-sm text-[#262626]">
                <li className="flex items-start gap-2">
                  <span className="text-[#133A1B]">•</span>
                  <span>
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    <span className="text-[#133A1B]">7일</span>간 발송될 수
                    있습니다.
                  </span>
                </li>
              </ul>
