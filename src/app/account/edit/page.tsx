					...
					<div className="flex flex-col gap-[10px]">
						...
						<div className="flex items-center gap-2">
							...
							<button
								...
								className="px-4 py-3 text-sm font-medium text-[#133A1B] border border-[#133A1B] whitespace-nowrap cursor-pointer"
							>
								비밀번호 변경
							</button>
						</div>
							...
							<div className="flex flex-col gap-[10px]">
								<div className="flex items-center gap-2">
									...
									<button
										...
										className="px-6 py-3.5 text-sm font-medium text-[#133A1B] border border-[#133A1B] whitespace-nowrap cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
									>
