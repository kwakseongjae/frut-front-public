...
const EditAccountPage = () => {
	...
	// 더미 데이터
	const [userId, _setUserId] = useState("kwakseongjae");
		...
		<div className="flex flex-col min-h-screen bg-white">
			...
			<div className="flex flex-col">
				...
				<div className="px-5 py-4 border-b border-[#E5E5E5]">
					<div className="text-xs font-medium text-[#595959] mb-2 block">
						아이디
					</div>
					<div className="flex items-center gap-4">
						<div className="flex-1 px-3 py-2 border border-[#D9D9D9] rounded text-sm text-[#262626] bg-white">
							{userId}
						</div>
					</div>
				</div>
