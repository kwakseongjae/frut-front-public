        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <div className="flex items-center gap-2">
              <h2 className="font-semibold text-[#262626]">지혁이 농장</h2>
            ...
            <div className="flex items-center gap-1">
              <StarIcon />
              <span className="text-xs text-[#595959]">4.8 (152)</span>
            </div>
            <div className="flex items-center gap-1">
              <LikeIcon />
              <span className="text-xs text-[#595959]">팔로워 5,458명</span>
            </div>
          </div>
        </div>
      </div>
...
const BusinessReviewsTab = ({
  ...
  const reviews: Review[] = [
    ...
    },
    {
      ...
      rating: 5,
      date: "2025.05.23",
      content: "정말 맛있어요! 다음에도 주문할 예정입니다.",
      productName: "태국 A급 남독마이 골드망고",
    },
    {
      id: 4,
      userName: "이*영",
