...
export default function Home() {
  ...
  // 배너 광고 조회
  const { data: mainBanners, isLoading: isLoadingMainBanners } = useBannerAds({
    ad_type: "MAIN",
  });
  const { data: middleBanners, isLoading: isLoadingMiddleBanners } =
    useBannerAds({ ad_type: "MIDDLE" });
