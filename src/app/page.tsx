...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      {/* 광고 배너 영역 */}
      <div className="w-full h-[430px] bg-[#EEEEEE] flex items-center justify-center text-2xl">
        광고 배너 영역
      </div>
      {/* 홈 화면 카드 영역 (중간 배너 이전)  */}
      ...
      {/* 중간 배너 영역 */}
      <div className="w-full h-[140px] bg-[#EEEEEE] flex items-center justify-center text-2xl">
        중간 배너 영역
      </div>
      {/* 홈 화면 카드 영역 (중간 배너 이후)  */}
      <div className="flex flex-col gap-8 px-6 py-8">
