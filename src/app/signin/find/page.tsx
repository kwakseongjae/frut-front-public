...
const FindAccountPageContent = () => {
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      // 아이디 찾기 탭이면 자동으로 아이디 찾기 실행 (인증 완료 상태로 호출)
      if (activeTab === "id") {
        await handleFindUsername(true);
  ...
  // 아이디 찾기
  const handleFindUsername = async (skipVerificationCheck = false) => {
      ...
      <div className="flex-1 px-5 py-4">
        {activeTab === "id" && foundUsername ? (
          ...
          <div className="flex flex-col">
            ...
            {/* 아이디 표시 박스 */}
            <div className="bg-[#F5F5F5] border border-[#E5E5E5] p-4 mb-8">
            ...
            <div className="flex gap-3 mt-auto">
              <button
                ...
                className="flex-1 py-[14px] text-sm font-semibold text-[#262626] border border-[#D9D9D9] bg-white"
              >
                비밀번호 찾기
              </button>
              <button
                ...
                className="flex-1 py-[14px] text-sm font-semibold text-white bg-[#133A1B]"
              >
                로그인
              </button>
            </div>
