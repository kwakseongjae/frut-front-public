      ...
      <div className="px-5 py-4">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4">
            <button className="cursor-pointer w-full py-[14px] bg-[#133A1B] text-sm font-semibold text-white">
              로그인
            </button>
            <div className="w-full flex justify-center divide-x divide-[#D9D9D9]">
              <button className="cursor-pointer text-xs font-medium text-[#949494] pr-2">
                아이디 찾기
              </button>
              <button className="cursor-pointer text-xs font-medium text-[#949494] pl-2">
                비밀번호 찾기
              </button>
            </div>
            <button className="cursor-pointer w-full py-[14px] text-sm font-semibold text-[#133A1B] border border-[#133A1B]">
              회원가입
            </button>
          </div>
        </div>
